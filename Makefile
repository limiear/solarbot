...
ubuntu:
	...
	@ sudo apt-get -y --force-yes install zlibc libssl1.0.0 libssl-dev libbz2-dev libxslt1-dev libxml2-dev python-gevent python-virtualenv python-dev libfreetype6-dev libpng12-dev libzip-dev m4 curl libxml2-dev libffi-dev
